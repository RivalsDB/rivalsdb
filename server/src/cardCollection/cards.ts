...
export const cards: Array<Card> = [
  ...
  } as Agenda,
  {
    ...
    clan: "hecata",
    name: "Scott",
    text: "When you create a wraith, choose your wraith token instead of drawing it at random. Shuffle the stack after choosing.",
    bloodPotency: 4,
    attributePhysical: 1,
    attributeSocial: 1,
    attributeMental: 0,
  ...
  } as Faction,
  {
    ...
    clan: "hecata",
    name: "Annika",
    text: "As you play a Ritual, you may move 1 [blood] from any number of your characters in torpor to that Ritual.",
    bloodPotency: 6,
    attributePhysical: 1,
    attributeSocial: 2,
    attributeMental: 0,
  ...
  } as Faction,
  {
    ...
    text: "Torpor - If you control 2+ Rituals, gain 1 [agenda].",
    bloodPotency: 2,
    attributePhysical: 0,
    attributeSocial: 0,
    attributeMental: 1,
  ...
  } as Faction,
  {
    types: ["action"],
    name: "Clairvoyance",
    text: "[auspex] Look at target foe's hand. Choose 1 Library card there and place it on top of their Library. Then gain 1 Unhosted Action.",
    disciplines: ["auspex"],
    illustrator: "Mara Miranda Escota",
    set: "Shadows & Shrouds",
    id: "sas-clairvoyance",
  ...
  } as Library,
  {
    ...
    damage: 1,
    name: "Cloud Memory",
    text: "[dominate] If this attack deals 1+ [damage] to the target, that foe discards 1 random Library card from their Hand.",
  ...
  } as Library,
  {
    types: ["action"],
    name: "Early Grave",
    text: "Recruit a Hecata character from your hand into torpor at no cost.",
    illustrator: "Marco Primo",
    set: "Shadows & Shrouds",
    id: "sas-early-grave",
  ...
  } as Haven,
  {
    ...
    text: "Ongoing - Each character in your coterie has +1 Influence for each [agenda] on them.",
  ...
  } as Library,
  {
    ...
    clan: "lasombra",
    name: "Gia de Emparan",
    text: "Party - When this party defeats a character, move 1 [agenda] from any character in your coterie to your Agenda card.",
    bloodPotency: 6,
    attributePhysical: 1,
    attributeSocial: 1,
    attributeMental: 1,
  ...
  } as Faction,
  {
    ...
    name: "Grave Robbing",
    clan: "hecata",
    text: "Draw 1 card and choose 1 player. For each character that player has in torpor, either draw 1 card or gain 1 [prestige]. _(Choose for each.)_",
    illustrator: "Marco Primo",
    set: "Shadows & Shrouds",
  ...
  } as Library,
  {
    ...
    attackType: ["social"],
    name: "High Stakes",
    text: "+1 [damage] for each [agenda] on the attacker.",
    bloodPotency: 4,
    damage: 1,
    illustrator: "Adelijah Ocampo",
    set: "Shadows & Shrouds",
  ...
  } as Library,
  {
    ...
    text: "+1 [damage] for each Ritual you control.",
    bloodPotency: 4,
    damage: 1,
    illustrator: "Harvey Bunda",
    set: "Shadows & Shrouds",
  ...
  } as Library,
  {
    ...
    attackType: ["social"],
    name: "Interrogation",
    text: "If this attack deals 1+ [damage] to the target, look at that foe's hand.",
    bloodPotency: 3,
    damage: 2,
    illustrator: "Irene Francisco",
    set: "Shadows & Shrouds",
  ...
  } as Faction,
  {
    ...
    clan: "hecata",
    name: "Kristin",
    text: "**Exhaust:** Target character in torpor loses 1 [blood].",
    bloodPotency: 2,
    attributePhysical: 0,
    attributeSocial: 1,
    attributeMental: 0,
  ...
  } as Faction,
  {
    ...
    clan: "hecata",
    name: "Kwame",
    text: "Torpor - If you control 2+ wraiths, draw 1 card.",
    bloodPotency: 4,
    attributePhysical: 1,
    attributeSocial: 0,
    attributeMental: 1,
  ...
  } as Faction,
  {
    ...
    attackType: ["physical"],
    name: "Money Shot",
    text: "[potence] If this attack defeats the target, put 1 [agenda] from the general supply on target character in any coterie.",
    disciplines: ["potence"],
    bloodPotency: 4,
    damage: 1,
    illustrator: "János Orbán",
  ...
  } as Library,
  {
    ...
    clan: "hecata",
    name: "Nathaniel",
    text: "Torpor - If you control 1+ Rituals, gain 1 [prestige].",
    bloodPotency: 3,
    attributePhysical: 0,
    attributeSocial: 1,
    attributeMental: 1,
  ...
  } as Faction,
  {
    ...
    name: "Necromancy",
    clan: "hecata",
    text: "Discard cards from the City Deck until you discard a Mortal, then burn that Mortal. If you burned a Mortal this turn, the active character may play a Ritual at no Action cost. If they do, they lose 2 [blood].",
    illustrator: "Irene Francisco",
    set: "Shadows & Shrouds",
    id: "sas-necromancy",
  ...
  } as Agenda,
  {
    ...
    text: "[fortitude] Deal additional [damage] equal to this character's [blood-potency] minus their current [blood].",
    disciplines: ["fortitude"],
    illustrator: "Joyce Maureira",
    set: "Shadows & Shrouds",
  ...
  } as Faction,
  {
    ...
    clan: "lasombra",
    name: "Raven Smith",
    text: "**Exhaust:** Steal 1 [agenda] from target foe who has the same amount of [agenda] as you and put it on this character.",
    bloodPotency: 5,
    attributePhysical: 0,
    attributeSocial: 2,
    attributeMental: 1,
  ...
  } as Faction,
  {
    ...
    damage: 0,
    name: "Shadow Boxing",
    text: "+1 [damage] for each [oblivion] this character has.\n\nIf the attacker has **Reach**, additional +1 [damage].",
    disciplines: ["oblivion"],
    illustrator: "Harvey Bunda",
    set: "Shadows & Shrouds",
  ...
  } as Library,
  {
    ...
    text: "Influence Conflict - Should I deal 1 **Aggravated** [damage] to target character and 1 additional **Aggravated** [damage] for every 5 Influence in favor of this Scheme?",
    illustrator: "Mara Miranda Escota",
    set: "Shadows & Shrouds",
  ...
  } as Library,
  {
    ...
    text: "Torpor - For each wraith you control, put 1 [blood] of your color from the general supply on target character (including in torpor).",
    bloodPotency: 5,
    attributePhysical: 1,
    attributeSocial: 0,
    attributeMental: 2,
  ...
  } as Faction,
  {
    ...
    clan: "brujah",
    name: "Annabelle",
    text: "Party - Characters in this party deal +1 Superficial [damage] to the opposing character during an attack for each Influence you exert during the attack.",
    bloodPotency: 4,
    attributePhysical: 1,
    attributeSocial: 1,
    attributeMental: 0,
  ...
  } as Faction,
  {
    ...
    clan: "malkavian",
    name: "Natasha Blank",
    text: "Attacker - **Pay 1 [prestige]:** This attack deals +1 [damage] to the target. At the end of this attack, you may move this character to your haven.",
    bloodPotency: 3,
    attributePhysical: 0,
    attributeSocial: 1,
    attributeMental: 1,
  ...
  } as Faction,
  {
    ...
    damage: 0,
    name: "Soul Crushing",
    text: "[oblivion] +1 [damage] for each card attached to the target.",
    disciplines: ["oblivion"],
    illustrator: "János Orbán",
    set: "Shadows & Shrouds",
  ...
  } as Library,
  {
    ...
    text: "**Exhaust 1 wraith attached to the acting character:** Ready target character in The Streets. They become a separate party. Take 1 additional Action with that character.",
    illustrator: "Harvey Bunda",
    set: "Shadows & Shrouds",
  ...
  } as Library,
  {
    types: ["action"],
    name: "Spirit's Touch",
    text: "[auspex] Reveal the top card of target player's Library. Gain [prestige] equal to its [blood-potency-requirement]. If you gain no [prestige] this way, discard the revealed card and ready the acting character.",
    disciplines: ["auspex"],
  ...
  {
    types: ["reaction"],
    reactionType: ["ranged", "physical", "social", "mental"],
    bloodPotency: 5,
    shield: 1,
    name: "Tenebrous Avatar",
    text: "[oblivion] **Pay 1 [agenda]:** +4 [shield] during this attack.",
    disciplines: ["oblivion"],
    illustrator: "János Orbán",
    set: "Shadows & Shrouds",
  ...
  } as Haven,
  {
    ...
    damage: 2,
    name: "Throwing Shade",
    text: "If this party has 2+ [oblivion], +1 [damage].",
    disciplines: ["oblivion"],
  ...
  } as Library,
  {
    ...
    damage: 1,
    name: "Utter Darkness",
    text: "[oblivion] Put a Fear token on the original target of this attack and the Blocker (if any).",
    disciplines: ["oblivion"],
    illustrator: "???",
    set: "Shadows & Shrouds",
  ...
  } as Library,
  {
    ...
    clan: "lasombra",
    text: "Influence Conflict - Should I steal 1 [agenda] from target foe with the most [agenda]? _(If there is a tie for most, choose only 1 of those foes.)_",
    illustrator: "János Orbán",
    set: "Shadows & Shrouds",
  ...
  } as Library,
  {
    types: ["action"],
    name: "Winning",
    text: "Put 1 [agenda] from the general supply on each character in your coterie.",
    illustrator: "Marco Primo",
    set: "Shadows & Shrouds",
    id: "sas-winning",
  ...
  } as Library,
  {
    ...
    clan: "hecata",
    name: "Zahara",
    text: "When this character is defeated, you may create a wraith and attach it to a character in your coterie.",
    bloodPotency: 3,
    attributePhysical: 1,
    attributeSocial: 1,
    attributeMental: 0,
  ...
  } as Library,
  {
    ...
    clan: "toreador",
    name: "Iris Lokken",
    text: "When this character plays a Scheme, reveal the top card of your Library and gain Influence equal to its [blood-potency] for this action (the return it).",
    bloodPotency: 4,
    attributePhysical: 0,
    attributeSocial: 0,
    attributeMental: 2,
