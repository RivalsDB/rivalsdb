...
Your Ongoing cards cannot be targeted by foes.
  ...
  "pp1-david-garcia": {
    ...
    name: "David Garcia",
    text: md`
    The first time you place a card face down outside of an attack each turn, place 1 [prestige] from your general supply on up to 2 other face-down cards you control.
    `,
    bloodPotency: 5,
    physical: 1,
    social: 1,
  ...
  "pp1-emile-rene": {
    ...
    name: "Emile Rene",
    text: md`
    **Pay 1 [blood]: Steal 1 [blood] from target character and put it on an Ongoing card you control.
    `,
    bloodPotency: 7,
    physical: 1,
    social: 2,
  ...
  "pp1-krisken-monroe": {
    ...
    name: "Krisken Monroe",
    text: md`
    When this character mends 1 [blood], put 1 additional [blood] from your general supply on them.
  ...
  "pp1-odellas-caine": {
    ...
    **Discard 1 card:** Replace 1 [blood] on target character with 1 of your color from the general supply.
    `,
    bloodPotency: 6,
    physical: 0,
    social: 2,
  ...
  "pp1-robert-bruce": {
    ...
    **Solitary**
    ...
    If this is the only character you control, characters with [blood] of your color have +1 [shield] during attack actions by your foes.
  ...
  "pp1-savage": {
    ...
    name: "Savage",
    text: md`
    Attacker - If the attack causes the target to become **Wounded**, exhaust the target and put a Fear token on them. This attack deals +1 [damage] to the target if the defending party has 3+ characters.
    `,
    bloodPotency: 7,
    physical: 2,
    social: 1,
